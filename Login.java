...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication/images/connection1.jpg"))); // NOI18N
...
ImageIcon A= new ImageIcon(getClass().getResource("images/quitter1.png"));
   ...
   String passwordcheck =jPasswordField1.getText();
            String id=jTextField1.getText();
            if(passwordcheck.equals("Devansh") && id.equals("Devansh") || passwordcheck.equals("Mrinal") && id.equals("Mrinal")|| passwordcheck.equals("Gaurav") && id.equals("Gaurav")){
                jPasswordField1.setText(null);
                 jTextField1.setText(null);  
                 
                 if( id.equals("Devansh")){
                Application app=new Application();
                app.setVisible(true);
                     app.jLabel17.setText(id);
                     ImageIcon F= new ImageIcon(getClass().getResource("images/Devansh.png"));
                ...
                app.setVisible(true);
                     app.jLabel17.setText(id);
                     ImageIcon F= new ImageIcon(getClass().getResource("images/Mrinal.png"));
                     app.jLabel9.setIcon(F);
                     this.dispose();
                 }
                     if( id.equals("Gaurav")){
                ...
                app.setVisible(true);
                     app.jLabel17.setText(id);
                     ImageIcon F= new ImageIcon(getClass().getResource("images/Gaurav.png"));
                     app.jLabel9.setIcon(F);
                     this.dispose();
                 }
            }
            else {
                JOptionPane.showMessageDialog(null,"Incorrect connection details","unable to connect",JOptionPane.ERROR_MESSAGE);
                 jPasswordField1.setText(null);
                 jTextField1.setText(null);
            }
    ...
    private void jLabel3MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseEntered
     ImageIcon B= new ImageIcon(getClass().getResource("images/connection2.jpg"));
    jLabel3.setIcon(B);
    }//GEN-LAST:event_jLabel3MouseEntered

    private void jLabel3MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseExited
ImageIcon B= new ImageIcon(getClass().getResource("images/connection1.jpg"));
